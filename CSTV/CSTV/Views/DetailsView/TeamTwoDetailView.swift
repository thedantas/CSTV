...
class TeamTwoDetailView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        NSLayoutConstraint.activate([
            ...
            playerView.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: 2),
            ...
            playerImageView.trailingAnchor.constraint(equalTo: self.leadingAnchor, constant: -113.76),
